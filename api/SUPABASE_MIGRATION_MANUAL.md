...
1. Collez le SQL ci-dessus dans l'éditeur
...
Une fois les tables créées, testez la connexion avec :
```bash
...
- ✅ Base de données prête pour le marketplace
